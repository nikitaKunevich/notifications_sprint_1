        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            (panel.models.NotificationStatuses["to_send"], "to_send"),
                            (
                                panel.models.NotificationStatuses["in_process"],
                                "in_process",
                            ),
                            (panel.models.NotificationStatuses["done"], "done"),
                            (
                                panel.models.NotificationStatuses["cancelled"],
                                "cancelled",
                            ),
                            (panel.models.NotificationStatuses["failed"], "failed"),
                        ],
                        default=panel.models.NotificationStatuses["to_send"],
                        max_length=250,
                    ),
                ),
                (
                    "channel",
                    models.CharField(
                        choices=[(panel.models.Channels["email"], "email")],
                        default=panel.models.Channels["email"],
                        max_length=250,
                    ),
                ),
