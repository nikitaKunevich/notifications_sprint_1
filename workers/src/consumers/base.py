...
class BaseConsumer:
    ...
    def connect(self):
        ...
        credentials = pika.PlainCredentials(
            self.__parameters.get("USERNAME"), self.__parameters.get("PASSWORD")
        )
        parameters = pika.ConnectionParameters(
            self.__parameters.get("HOST"), credentials=credentials
        )
    ...
    def on_channel_open(self, channel):
        ...
        self.setup_exchange(self.__parameters.get("EXCHANGE"))
    ...
    def setup_exchange(self, exchange_name) -> None:
        ...
        if self._channel:
            self._channel.exchange_declare(
                ...
                exchange_type=self.__parameters.get("EXCHANGE_TYPE"),
                callback=cb,
            )
    ...
    def on_exchange_declareok(self, _unused_frame, userdata):
        ...
        self.setup_queue(self.__parameters.get("QUEUES"))
    ...
    def on_queue_declareok(self, _unused_frame, userdata):
        ...
        self.logger.info(
            ...
            self.__parameters.get("EXCHANGE"),
            queue_name,
            self.__parameters.get("ROUTING_KEY"),
        )
        cb = functools.partial(self.on_bindok, userdata=queue_name)
        if self._channel:
            for routing_key in self.__parameters.get("ROUTING_KEY").split(","):
    ...
    def start_consuming(self):
        ...
        for queue in self.__parameters.get("QUEUES"):
            if self._channel:
